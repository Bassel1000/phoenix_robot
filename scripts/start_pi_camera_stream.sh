...
echo "Starting Raspberry Pi Camera Module 3 stream on tcp://0.0.0.0:8889"
echo "Remember to set PI_CAMERA_URL=\"tcp://<PI_IP>:8889\" in your laptop's .env file"
echo ""

sudo rpicam-vid -n -t 0 --mode 4608:2592:12 --width 640 --height 360 --framerate 30 --codec mjpeg --listen -o tcp://0.0.0.0:8889
